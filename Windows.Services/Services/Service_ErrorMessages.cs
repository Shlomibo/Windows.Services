...
namespace Windows.Services
{
	partial class Service
	{
		...
		private static readonly Dictionary<int, string> deleteServiceMessages = new Dictionary<int, string>()
		{
		...
		private static readonly Dictionary<int, string> createServiceMessages = new Dictionary<int, string>()
		{
			...
			[Win32API.ERROR_DUPLICATE_SERVICE_NAME] = 
				"The display name already exists in the service control manager database either as " +
				"a service name or as another display name.",
		...
		private static readonly Dictionary<int, string> loadConfigMessages = new Dictionary<int, string>()
		{
			[Win32API.ERROR_ACCESS_DENIED] = "The handle does not have the SERVICE_QUERY_CONFIG access right.",
			[Win32API.ERROR_INVALID_HANDLE] = "The specified handle is invalid.",
		};

		private static readonly Dictionary<int, string> setConfigMessages = new Dictionary<int, string>()
		{
		...
		private static readonly Dictionary<int, string> sendControlMessages = new Dictionary<int, string>()
		{
		...
		private static readonly Dictionary<int, string> serviceStatusMessages = new Dictionary<int, string>()
		{
		...
		private static readonly Dictionary<int, string> startServiceMessages = new Dictionary<int, string>()
		{
